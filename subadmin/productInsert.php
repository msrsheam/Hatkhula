<?php
  ...
  if (isset($_POST['productPost'])) {
    ...
    $sqlForProductInsert = " insert into product (productName,status,price,discount,postedBy,company,discription,subCategory,category,image1,image2,image3) values ('$productName',1,$price,$productDiscount,'admin','$company','$discription','$subCategory','$category','$newfilename1','$newfilename2','$newfilename3') ";
