...
<div class="banner-bootom-w3-agileits">
	<div class="container">
		<?php
			$query = "SELECT * FROM product where productName LIKE '%$urlSearch%' or company LIKE '%$urlSearch%' or category LIKE '%$urlSearch%' or subCategory LIKE '%$urlSearch%' or price LIKE '%$urlSearch%' or discount LIKE '%$urlSearch%' or discription LIKE '%$urlSearch%' ORDER BY productId ASC";
			...
			<div class="men-pro-item simpleCart_shelfItem">
				...
				<div class="item-info-product ">
					...
					<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
						<form method="post" action="?action=addcart&search=<?php echo $urlSearch; ?>">
							<fieldset>
