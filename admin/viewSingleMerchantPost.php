<?php
  ...
  //from url
  $merchantName = $_REQUEST['userName'];
...
<head>
  ...
  <title>Hatkhula | merchant post </title>
...
<?php
  $sqlForProduct = "select * from product where (postedBy = '$merchantName') AND status = 1 ";
  $queryForProduct = mysqli_query($con,$sqlForProduct);
  $counntProduct = mysqli_num_rows($queryForProduct);
?>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h1 class="box-title"><?php echo $merchantName;?>'s Product <?php echo "(".$counntProduct.")"; ?> </h1>
            </div>
            <!-- /.box-header -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                        ...
                        <td>
                          <a href="deleteSingleProduct.php?productId=<?php echo $info['productId'];?>&$merchantName=<?php echo $merchantName; ?>" class="btn btn-danger btn"><i class="fa fa-trash" style="font-size:25px;color:white;"></i></a>
                        </td>
