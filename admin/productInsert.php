...
<?php
  ...
  if (isset($_POST['productPost'])) {
    ...
    $sqlForProductInsert = " insert into product (productName,status,price,discount,postedBy,company,discription,subCategory,category,image1,image2,image3) values ('$productName',1,$price,$productDiscount,'$userName','$company','$discription','$subCategory','$category','$newfilename1','$newfilename2','$newfilename3') ";
      ...
      function dynamicdropdown(listindex)
      {
        ...
        document.getElementById("subCategory").options[0]=new Option("Refrigerator/ Freezer","Refrigerator/ Freezer");
          ...
          case "Watch and Clock" :
            ...
            break;
          case "Gift Item" :
            document.getElementById("subCategory").options[0]=new Option("Cake","Cake");
            document.getElementById("subCategory").options[1]=new Option("Flower","Flower");
            document.getElementById("subCategory").options[2]=new Option("Chocolate","Chocolate");
            document.getElementById("subCategory").options[3]=new Option("Trees","Trees");
            document.getElementById("subCategory").options[4]=new Option("Pets","Pets");
            document.getElementById("subCategory").options[5]=new Option("Sweets","Sweets");
            document.getElementById("subCategory").options[6]=new Option("Combo Gift","Combo Gift");
            document.getElementById("subCategory").options[7]=new Option("Others Gift Item","Others Gift Item");
