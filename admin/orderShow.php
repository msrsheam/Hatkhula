            ...
            <div class="box-body" style="overflow-x: auto;">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $sqlForViewSubAdmin ="select orders.oStatus,orders.oId,odetails.productName,odetails.productId
                        ,odetails.size,odetails.quantity,orders.tType,orders.tNo,odetails.price,orders.oDate,customer.name,
                        customer.phone,shipping.sName,shipping.sPhone,shipping.sAddress,shipping.sCity from
                        orders  inner join customer on customer.cId = orders.cId inner join
                        shipping on customer.email = shipping.cEmail inner join
                         odetails on orders.oId = odetails.oId inner join product on odetails.productId = product.productId
                          where oStatus = 0 and postedBy = 'admin'";
