...
<head>
  ...
  <title>Hatkhula | Message List</title>
    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h1 class="box-title"> Message List </h1>
            </div>
            <!-- /.box-header -->
            <div class="box-body" style="overflow-x: auto;">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $serialNo = 1;
                        //for view sub admins
                        $sqlForViewSubAdmin ="select * from contact";
                        ...
                        <td>
                          <a href="?&adminId=<?php echo $info['id'];?>" class="btn btn-danger btn"><i class="fa fa-trash" style="font-size:30px;color:white;"></i></a>
                        </td>
                    </tr>
                    <?php $serialNo++;}?>
                    </tbody>
