...
<div class="banner-bootom-w3-agileits">
	<div class="container">
		<?php
			$query = "SELECT * FROM product where discount >0 ORDER BY productId ASC";
		...
		<?php if(empty($products)):?>
		    ...
		    <div class="container pull-center" style="width:300px;">
		      <div class="navbar-header"> <a class="navbar-brand" href="index.php" style="color:#FFFFFF;">No products found.</a> </div>
		    </div>
		  </nav>
		<?php endif;?>
